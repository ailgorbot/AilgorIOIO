...
public class MjpegServer extends SimpleServer {
    ...
    private void sendDefault(OutputStream out) throws IOException {
        String content = "<html>" +
                "<head><title>AilgorIOIO</title></head>" +
//                "<body><img src='/?action=stream' alt='Camera is not available.' style='display'/></body>" +
               "<body><img src='/?action=stream' alt='Camera is not available.' style='display: block;transform:rotate(-90deg)'/></body>" +
